...
From version 1.2 you can also use a number of additional tags which will override the default TinyURL for shortening URLs. Simply include one of the following...
